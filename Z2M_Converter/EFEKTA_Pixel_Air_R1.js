...
const tzLocal = {
	co2_config: {
        key: ['auto_brightness', 'night_onoff_backlight', 'night_on_backlight', 'night_off_backlight', 'automatic_scal', 'forced_recalibration', 'factory_reset_co2', 'manual_forced_recalibration'],
...
const definition = {
        ...
        fromZigbee: [fz.temperature, fz.humidity, fz.pressure, fzLocal.illuminance, fzLocal.co2, fzLocal.co2_config,
        ...
        exposes: [e.co2(), e.temperature(), e.humidity(), e.illuminance(), e.illuminance_raw(), e.pressure(),
